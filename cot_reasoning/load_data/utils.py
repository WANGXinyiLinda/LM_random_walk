...
def compare_both_string_and_number_format(answer, groundtruth):
    if number_it(groundtruth) is not None:
        if number_it(answer) is not None:
            return compare_two_numbers(number_it(answer), number_it(groundtruth))
        else:
            return False
    else:
